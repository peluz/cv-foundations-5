    ...
    def testModel(self):
        ...
        for word, imlist in self.testImages.items():
            ...
            for im in imlist:
                ...
                predictions_n.append(self.name_dict[str(int(cl[0]))])
                labels.append(word)

        self.labels = np.array(labels)
        self.predictions = np.array(predictions_n)
        ...
        #for each in predictions:
            ...
            #
            #print("class: ",each['object_name']," class: ", each['class'])
...
if __name__ == '__main__':
    ...
    print("Accuracy: ",bov.accuracy)
    print("Confusion matrix: ",bov.confusion_matrix)
"""
